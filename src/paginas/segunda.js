...
const Segunda = () => {
  ...
  const q1 = query(equiposCollection, where("categoria", "==", "segunda"), orderBy("puntos", "desc"));
            ...
            <ul className="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              ...
              <li >
                  <NavDropdown title="Categorías" id="categoriasDropdown" className="navbar-categorias">
                      ...
                      <Link to="/contacto"><NavDropdown.Item className="dropdown-item-custom"href="#primera">Segunda</NavDropdown.Item></Link>
                  </NavDropdown>
              </li>
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-5 ml-auto">
          <h1 className="text-white">Segunda</h1>
      ...
      <div className="">
        <nav className="site-navigation text-left" >
          <ul className="site-menu main-menu">
            <li className="active"><Link  to="/segunda" className="nav-link">EQUIPOS |</Link></li>
            <li><Link to="/tablaSegunda">TABLA DE POSICIONES |</Link></li>
            <li><Link to="/jornadasSegunda">FECHAS |</Link></li>
          </ul>
        </nav>
...
<div className="container site-section">
      <div className="row">
        <div className="col-6 title-section">
          <h2 className="heading">Equipos aprobados en Segunda</h2>
          <br></br>
        </div>
      </div>
      <div className="row">
        ...
        <div className="custom-media d-flex">
            ...
            <p><a href="#">Primera -  San Carlos</a></p>
            </div>
        </div>
    </div>
  ))}
