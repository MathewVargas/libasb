...
const TablaMaxMax = () => {
  ...
  const q1 = query(tablaCollection, where("categoria", "==", "maxima"), orderBy("puntos", "desc"));
      ...
      <div className="">
        <nav className="site-navigation text-left" >
          <ul className="site-menu main-menu">
            ...
            <li className="active"><Link to="/tablaMax">Tabla DE POSICIONES |</Link></li>
...
<div class="container">
        ...
        <div className="col-6 title-section">
          <h2 className="heading">Tabla de posiciones Máxima</h2>
        </div>
          <div class="col-lg-12">
