...
const TablaSegunda = () => {
  ...
  const q1 = query(tablaCollection, where("categoria", "==", "segunda"), orderBy("puntos", "desc"));
      ...
      <div className="">
        <nav className="site-navigation text-left" >
          <ul className="site-menu main-menu">
            <li ><Link  to="/segunda" className="nav-link">EQUIPOS |</Link></li>
            <li className="active"><Link to="/tablaSegunda">Tabla DE POSICIONES |</Link></li>
...
<div class="container">
        ...
        <div className="col-6 title-section">
          <h2 className="heading">Tabla de posiciones Segunda</h2>
        </div>
          <div class="col-lg-12">
