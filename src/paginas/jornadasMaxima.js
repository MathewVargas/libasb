...
const JornadasMaxima  = () =>  {
//1 - configuramos los hooks
const [JornadasMax, setTabla] = useState([]);
const [equipos, setEquipos] = useState([]);

//2 - referenciamos a la DB firestore
const tablaCollection = collection(db, "jornadasmaxima");
    ...
    <Fragment>
        ...
        <div className="container">
            ...
            <div className="col-lg-5 mx-auto text-center">
                <h1 className="text-white">Máxima</h1>
            ...
            <div className="container">
                ...
                <div className="">
                    ...
                    <ul className="site-menu main-menu">
                        <li ><Link  to="/maxima" className="nav-link">EQUIPOS |</Link></li>
                        <li><Link to="/tablaMax">TABLA DE POSICIONES |</Link></li>
                        <li className="active"><Link to="/jornadasMax">FECHAS |</Link></li>
                    </ul>
                    </nav>
        ...
        <div className="row">
            <div className="col-12 title-section">
                <h2 className="heading">Próxima Fecha Máxima</h2>
            </div>
