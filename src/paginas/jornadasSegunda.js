...
const JornadasSegunda  = () =>  {
//1 - configuramos los hooks
const [JornadasMax, setTabla] = useState([]);
const [equipos, setEquipos] = useState([]);

//2 - referenciamos a la DB firestore
const tablaCollection = collection(db, "jornadasSegunda");
    ...
    <Fragment>
            ...
            <div className="container">
                ...
                <div className="">
                    ...
                    <ul className="site-menu main-menu">
                        ...
                        <li className="active"><Link to="/jornadasSegunda">FECHAS |</Link></li>
                    </ul>
                    </nav>
        ...
        <div className="row">
            <div className="col-12 title-section">
                <h2 className="heading">Fechas Segunda</h2>
            </div>
...
export default JornadasSegunda;